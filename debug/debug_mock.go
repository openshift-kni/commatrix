...
// Source: github.com/openshift-kni/commatrix/debug (interfaces: DebugPodInterface)
//
// Generated by this command:
//
//	mockgen -destination=debug_mock.go -package=debug . DebugPodInterface
//
...
func (m *MockDebugPodInterface) ExecWithRetry(arg0 string, arg1, arg2 time.Duration) ([]byte, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExecWithRetry", arg0, arg1, arg2)
	ret0, _ := ret[0].([]byte)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDebugPodInterfaceMockRecorder) ExecWithRetry(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecWithRetry", reflect.TypeOf((*MockDebugPodInterface)(nil).ExecWithRetry), arg0, arg1, arg2)
}
