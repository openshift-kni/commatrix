...
func Run(o *GenerateOptions) (err error) {
	...
	if !slices.Contains(types.SupportedTopologies, controlPlaneTopology) {
		return fmt.Errorf("unsupported control plane topology: %s. Supported topologies are: %v", controlPlaneTopology, types.SupportedTopologies)
	}
	...
	if o.openPorts {
		ssMat, err := generateSS(o, controlPlaneTopology)
		if err != nil {
...
func generateMatrix(o *GenerateOptions, controlPlaneTopology configv1.TopologyMode, platformType configv1.PlatformType, ipv6Enabled bool) (*types.ComMatrix, error) {
	...
	err = matrix.WriteMatrixToFileByType(o.utilsHelpers, consts.CommatrixFileNamePrefix, o.format, controlPlaneTopology, o.destDir)
	if err != nil {
...
func generateSS(o *GenerateOptions, controlPlaneTopology configv1.TopologyMode) (*types.ComMatrix, error) {
	if o.debug {
		log.SetLevel(log.DebugLevel)
	}
	...
	err = ssMat.WriteMatrixToFileByType(o.utilsHelpers, consts.SSMatrixFileNamePrefix, o.format, controlPlaneTopology, o.destDir)
	if err != nil {
