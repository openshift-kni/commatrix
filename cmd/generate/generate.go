...
var (
	commatrixLong = templates.LongDesc(`
			  ...
			  This command will generate EndpointSlice matrix and the the matrix of host open ports, and their differences in selected format.
	...
	CommatrixExample = templates.Examples(`
			 # Generate communication matrices including EndpointSlice, host open ports, and their differences in selected format:
			 oc commatrix generate --host-open-ports --format (json|yaml|csv|nft)
